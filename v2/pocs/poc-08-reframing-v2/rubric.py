"""Rubric encoding: 8-role Bagua rubric prompt + strict JSON parsing.

Copied from v2/probes/path-d/rubric.py (reference protocol for the POC-03
diversity metric: statements are encoded into normalized 8-dim rubric
vectors and compared by cosine distance).
"""
